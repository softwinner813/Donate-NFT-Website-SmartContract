...
BASE_IMAGE_URL = "ipfs://QmYAg29LwFWQeeGRiWSfK6Zv3QWbXYxsb7VEnt4B6Z4Qik"
BASE_NAME = "Peace2UkraineNFT"

BASE_JSON = {
    "name": BASE_NAME,
    "description": "A Collection of my First Sample NFT",
...
def generate_paths(edition_name):
    ...
    metadata_path = os.path.join(edition_path, 'map1.csv')
